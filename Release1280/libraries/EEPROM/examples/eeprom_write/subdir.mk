...
OBJS += \
./libraries/EEPROM/examples/eeprom_write/eeprom_write.o 

INO_DEPS += \
./libraries/EEPROM/examples/eeprom_write/eeprom_write.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/EEPROM/examples/eeprom_write/%.o: ../libraries/EEPROM/examples/eeprom_write/%.ino
	@echo 'Building file: $<'
