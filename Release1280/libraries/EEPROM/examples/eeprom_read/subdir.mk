...
OBJS += \
./libraries/EEPROM/examples/eeprom_read/eeprom_read.o 

INO_DEPS += \
./libraries/EEPROM/examples/eeprom_read/eeprom_read.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/EEPROM/examples/eeprom_read/%.o: ../libraries/EEPROM/examples/eeprom_read/%.ino
	@echo 'Building file: $<'
