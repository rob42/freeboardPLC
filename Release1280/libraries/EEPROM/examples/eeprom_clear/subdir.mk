...
OBJS += \
./libraries/EEPROM/examples/eeprom_clear/eeprom_clear.o 

INO_DEPS += \
./libraries/EEPROM/examples/eeprom_clear/eeprom_clear.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/EEPROM/examples/eeprom_clear/%.o: ../libraries/EEPROM/examples/eeprom_clear/%.ino
	@echo 'Building file: $<'
