...
OBJS += \
./libraries/LiquidCrystal/examples/setCursor/setCursor.o 

INO_DEPS += \
./libraries/LiquidCrystal/examples/setCursor/setCursor.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/LiquidCrystal/examples/setCursor/%.o: ../libraries/LiquidCrystal/examples/setCursor/%.ino
	@echo 'Building file: $<'
