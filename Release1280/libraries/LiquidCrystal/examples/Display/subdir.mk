...
OBJS += \
./libraries/LiquidCrystal/examples/Display/Display.o 

INO_DEPS += \
./libraries/LiquidCrystal/examples/Display/Display.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/LiquidCrystal/examples/Display/%.o: ../libraries/LiquidCrystal/examples/Display/%.ino
	@echo 'Building file: $<'
