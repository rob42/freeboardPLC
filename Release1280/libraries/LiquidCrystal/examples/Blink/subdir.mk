...
OBJS += \
./libraries/LiquidCrystal/examples/Blink/Blink.o 

INO_DEPS += \
./libraries/LiquidCrystal/examples/Blink/Blink.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/LiquidCrystal/examples/Blink/%.o: ../libraries/LiquidCrystal/examples/Blink/%.ino
	@echo 'Building file: $<'
