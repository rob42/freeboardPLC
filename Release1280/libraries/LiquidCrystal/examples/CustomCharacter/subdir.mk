...
OBJS += \
./libraries/LiquidCrystal/examples/CustomCharacter/CustomCharacter.o 

INO_DEPS += \
./libraries/LiquidCrystal/examples/CustomCharacter/CustomCharacter.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/LiquidCrystal/examples/CustomCharacter/%.o: ../libraries/LiquidCrystal/examples/CustomCharacter/%.ino
	@echo 'Building file: $<'
